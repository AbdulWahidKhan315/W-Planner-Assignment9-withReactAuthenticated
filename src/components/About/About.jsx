        ...
        <div>
            <div className="flex flex-col lg:flex-row gap-10 items-center mt-10 justify-center border-b-4 border-violet-700 border-dotted">
                ...
                <div className="relative">
                    <img data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500" className="rounded-lg mb-10" src={'https://i.ibb.co/KbMZ3qv/aboutUs.jpg'} alt="" />
                    <div className="absolute top-2 left-2 hidden md:flex">
                        <img data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" className="w-1/3 rounded-lg" src={'https://i.ibb.co/0cv9s1d/thumbnail3.jpg'} alt="" />
                    </div>
                    <div className="absolute top-48 left-8 hidden md:flex">
                        <img data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-offset="0" className="w-1/3 rounded-lg" src={'https://i.ibb.co/r4BdRVV/thumbnail2.jpg'} alt="" />
                    </div>
