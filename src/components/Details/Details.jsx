...
const Details = ({ details }) => {
    ...
    const { title, image_url, _details, discount_des, review, service_taken,experties_say,thumbnail_url1,
        thumbnail_url2,thumbnail_url3 } = details || {}
    return (
        <div>
            <div className="flex flex-col lg:flex-row justify-center items-center container mx-auto gap-10">
                ...
                <div className="">
                    ...
                    <p>{_details}</p>
                    <h3 className="text-2xl text-violet-700 italic mt-4 underline"><span className="text-4xl font-bold">Discount</span> with terms and conditions-</h3>
                    <p>{discount_des}</p>
